...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-dark-900">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 bottom-0 w-64 bg-dark-800 border-r border-dark-700 z-50
      ...
      <div className="flex-1 flex flex-col min-h-screen lg:ml-0">
        {/* Header */}
        <header className="sticky top-0 z-30 h-16 bg-dark-800 border-b border-dark-700 flex items-center justify-between px-4 lg:px-6">
          <button 
